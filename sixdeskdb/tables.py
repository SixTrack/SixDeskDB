...
class Da_Vst(object):
  ...
  ('tunex', 'float', 'tunex value'),
  ('tuney' ,'float', 'tuney value'),
  ('dawavg', 'float', 'DAw avg.'),
  ('dasavg', 'float', 'DAs avg.'),
  ('dawsimp', 'float', 'DAw simp. integ.'),
  ('dassimp', 'float', 'DAs simp. integ.'),
  ('dawavgerr','float', 'error DAw avg.'),
  ('dasavgerr','float', 'error DAs avg.'),
  ('dasavgerrep', 'float', 'error DAs avg.'),
  ('dasavgerrepang', 'float', 'angular error DAs'),
  ('dasavgerrepamp', 'float', 'amplitude error DAs'),
