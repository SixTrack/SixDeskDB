...
# -------------------------------- da_vs_turns -----------------------------------------------------------
  ...
  def get_da_vst(self,seed,tune):
    ...
    if(self.check_table('da_vst')):
      ftype=[('seed',int),('tunex',float),('tuney',float),('turn_max',int),('dawtrap',float),('dastrap',float),('dawsimp',float),('dassimp',float),('dawtraperr',float),('dastraperr',float),('dastraperrep',float),('dastraperrepang',float),('dastraperrepamp',float),('dawsimperr',float),('dassimperr',float),('meanda',float),('meandaerr',float), ('nturn',float),('tlossmin',float), ('nturnavg',float) , ('mtime',float)]
      cmd="""SELECT *
